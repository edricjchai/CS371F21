...
class MyLinkedList implements Iterable{
    ...
    public class Node{
        ...
        public  Node addBefore( Block block){
            Node node = new Node(block);
        ...
        public  Node addAfter(Block block){
            Node node = new Node(block);
            node.previous = this;
            node.next = next;
            if(next == null)
...
@FunctionalInterface interface AllocationStrategy{
    int allocate( MyLinkedList free, int size);
}
...
class MyMemoryAllocation extends MemoryAllocation{
    ...
    private
    MyLinkedList.Node skipWhile( MyLinkedList.NodeIterator iterator,  Predicate<MyLinkedList.Node> predicate){
    ...
    private enum Algorithm{
        ...
        public static  Algorithm find( String name){
        ...
        Algorithm( String name, AllocationStrategy strategy){
            this.name = name;
            this.strategy = strategy;
        }

        public int allocate(MyLinkedList free, int size){
